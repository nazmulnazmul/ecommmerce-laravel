...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'delevary_address' => $request->delevary_address,
        ...
        OrderDetails::newOrderDetails (Order::orderBy('id', 'desc')->first()->id);
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'tax_total'             => 15,
                'shipping_total'        => 15,
                'delevary_address'      => 'Mohammadpur, Dhaka',
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->order_status == 'pendding') {
